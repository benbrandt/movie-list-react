...
declare module "ramda/src/flatten" {
  declare module.exports: <T, X>(xs: Array<Array<T> | X>) => Array<T | X>;
}
...
declare module "ramda/src/pipe" {
  declare module.exports: (<A, B, C, D, E, F, G>(
    ab: UnaryFn<A, B>,
    bc: UnaryFn<B, C>,
    cd: UnaryFn<C, D>,
    de: UnaryFn<D, E>,
...
declare module "ramda/src/range" {
  declare module.exports: CurriedFunction2<number, number, Array<number>>;
}
